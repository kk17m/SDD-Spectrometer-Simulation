...
// -------------------------------------------------------------------
//
/// \file SDDDetectorHit.cc
/// \brief Implementation of the SDDDetectorHit class
//
...
G4ThreadLocal G4Allocator<SDDDetectorHit> *AllocHit = 0;
...
SDDDetectorHit::SDDDetectorHit(const SDDDetectorHit& right):
    G4VHit(right)
{
    fEdep = right.fEdep;
    fPosition = right.fPosition;
    fTrackWeight = right.fTrackWeight;
    fdetID = right.fdetID;
}
...
int SDDDetectorHit::operator==(const SDDDetectorHit&) const
{
    return 0;
}
